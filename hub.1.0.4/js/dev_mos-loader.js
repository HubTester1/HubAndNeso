...
if (debugMode) { console.log("using dev_mos-loader m705") }
...
var stylesheetsToLoad = [
	...
	// Full Calendar
	{ "centrallyManaged": 1, "css": 1, "lib": 1, 	"path": "fullcalendar.3.9.0.min.css" },
	// Office UI Fabric
...
var librariesToLoad = [
	...
	// Moment JS
	{ "centrallyManaged": 1, "js": 1, "updatedLibs": 1, 		"path": "moment.withLocales.2.22.2.min.js" },
	{ "centrallyManaged": 1, "js": 1, "lib": 1, 				"path": "moment.recur.min.js" },
	// Full Calendar
	{ "centrallyManaged": 1, "js": 1, "updatedLibs": 1, 		"path": "fullcalendar.3.9.0.min.js" },
	// Collapsible
...
function ReturnURLToLoad(file, mData) {
	...
	if (typeof (file.updatedLibs) != "undefined" && file.updatedLibs == 1) {
		urlToLoad += "updatedLibs/";
	}
