(function ($) {
	...
	// fData.CustomScriptLast += '$("h2#header_this-request, div#label-and-control_Request-Nickname").hide("fast").addClass("hidden"); \n';

	fData.CustomScriptLast += '$("input#Request-Nickname").val("Generated by IIT"); \n';
