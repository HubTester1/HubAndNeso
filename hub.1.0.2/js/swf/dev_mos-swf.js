...
(function($) {
    ...
    $.fn.InitializeForm = function(mData, uniqueElements, customScriptFirst, customScriptLast) {
        ...
        console.log('using dev_mos-swf.js m2');
        console.log(mData);
        ...
        if (typeof(mData.standardElementGroups.standardPrintButton) != "undefined") {
            ...
            var standardPrintButton = [
                {
                    ...
                    'content': mData.standardElementGroups.standardPrintButton.buttonText,
                    'dataAttributes': [{
                        'key': 'print-function',
                        'value': mData.standardElementGroups.standardPrintButton.printFunction
                    }],
                    'begin': 1,
                    'end': 1,
                    'hideForNonAdmin': [""],
        ...
        if (mData.standardElementGroups != undefined) {
            ...
            if (mData.standardElementGroups.standardPrintButton != undefined) {
                mData.elements = standardPrintButton;
            } else {
                mData.elements = [];
            }

            if (mData.standardElementGroups.standardThisRequestAndRequesterElements != undefined) {
                mData.elements = mData.elements.concat(standardThisRequestAndRequesterElements);
            }
            ...
            if (mData.standardElementGroups.standardButtonElementsInitiallyHidden != undefined) {
                mData.elements = mData.elements.concat(standardButtonElementsInitiallyHidden);
            }
            ...
            switch (elem.elementType) {
                case "field":
                    ...
                    switch (elem.controlType) {
                        ...
                        case "legacyFileSet":
                            formMarkup += $().BuildLegacyFileSetField(elem, uData.isAdmin, rData.requestStatus);
                            formScript += $().BuildScript(elem, uData, mData);
                            break;
                    ...
                    completefunc: function(xData, Status) {
                        ...
                        // if swfList save was successful
                            ...
                            if (typeof(mData.notifications) == "undefined" || mData.notifications != 1) {
                                ...
                                // if processing event space notifications
                                if (typeof(mData.eventNeedsNotifications) != "undefined") {
                                    // if NOT just saving an allowed change after EOL has already been reached
                                    if (rData.endOfLife == 0 || (rData.endOfLife == 1 && rData.endOfLifeIsNew == 1)) {
                                        // pass sData to ProcessEventSpaceNotifications
                                ...
                                if (typeof(mData.interpreterReqNotifications) != "undefined") {
                                    ...
                                    if (rData.endOfLife == 0 || (rData.endOfLife == 1 && rData.endOfLifeIsNew == 1)) {
                                        ...
                                        // pass sData to ProcessInterpreterReqNotifications
                                ...
                                if (typeof(mData.photoReqNotifications) != "undefined") {
                                    ...
                                    if (rData.endOfLife == 0 || (rData.endOfLife == 1 && rData.endOfLifeIsNew == 1)) {
                                        ...
                                        // pass sData to ProcessPhotoReqNotifications
                                ...
                                if (typeof(mData.logoReqNotifications) != "undefined") {
                                    ...
                                    if (rData.endOfLife == 0 || (rData.endOfLife == 1 && rData.endOfLifeIsNew == 1)) {
                                        ...
                                        // pass sData to ProcessLogoReqNotifications
...
/*
                                ...
                                if (typeof(mData.functionSpaceReqNotifications) != "undefined") {
                                    ...
                                    if (rData.endOfLife == 0 || (rData.endOfLife == 1 && rData.endOfLifeIsNew == 1)) {
                                        ...
                                        // pass sData to ProcessFunctionSpaceReqNotifications
...
*/
                            ...
                            var attachments = $("div#mos-form").find('input.mos-file');
                            ...
                            console.log("attachmentsToAttemptCounter = " + attachmentsToAttemptCounter);
...
*/
    ...
    $.fn.BuildLegacyFileSetField = function(e, isAdmin, rStatus) {
    ...
    $.fn.ReturnHyphenatedFieldNameOrValue = function(nameOrValue) {
        return ReplaceAll("\\.", "", ReplaceAll("\\'", "", ReplaceAll(" ", "-",  nameOrValue)));
    };
    ...
    function PrintNeedsSheet () {
        ...
        // get raw data
        var sheetData = globalRData.formData;
        ...
        if (sheetData["Event-Space"] == "Other") {
            sheetData["Printer-Event-Space"] = sheetData["Other-Event-Space"];
        } else {
            sheetData["Printer-Event-Space"] = sheetData["Event-Space"];
        }
...
/*        if ( typeof(sheetData["wolfgang-puck-catering_menu"]) != "undefined" && typeof(sheetData["wolfgang-puck-catering_linens"]) != "undefined" ) {
            sheetData["Printer-WPC-Menu-Linens"] = "Both";
        }
        if ( typeof(sheetData["wolfgang-puck-catering_menu"]) == "undefined" && typeof(sheetData["wolfgang-puck-catering_linens"]) != "undefined" ) {
            sheetData["Printer-WPC-Menu-Linens"] = "Linens only";
        }
        if ( typeof(sheetData["wolfgang-puck-catering_menu"]) != "undefined" && typeof(sheetData["wolfgang-puck-catering_linens"]) == "undefined" ) {
            sheetData["Printer-WPC-Menu-Linens"] = "Menu only";
        }
*/
        ...
        if ( typeof(sheetData["wolfgang-puck-catering_menuandlinens"]) != "undefined" ) {
            sheetData["Printer-WPC-Menu-Linens"] = "Both menu and linens";
        }
        if ( typeof(sheetData["wolfgang-puck-catering_none"]) != "undefined" ) {
            sheetData["Printer-WPC-Menu-Linens"] = "No menu or linens";
        }
        ...
        if ( typeof(sheetData["iit_infra"]) == "undefined" && typeof(sheetData["iit_audiovisual"]) == "undefined" ) {
            sheetData["Printer-IIT-Assistance"] = "Both Help Desk / Infrastracture and A/V";
        }
        if ( typeof(sheetData["iit_infra"]) == "undefined" && typeof(sheetData["iit_audiovisual"]) != "undefined" ) {
            sheetData["Printer-IIT-Assistance"] = "A/V only";
        }
        if ( typeof(sheetData["iit_infra"]) != "undefined" && typeof(sheetData["iit_audiovisual"]) != "undefined" ) {
            sheetData["Printer-IIT-Assistance"] = "Help Desk / Infrastracture only";
        }
        ...
        printContent += '<h2>Event Basics</h2>' + 
                        ...
                        '       <li><b>Event Space:</b> ' + sheetData["Printer-Event-Space"] + '</li>' + 
        ...
        // event schedule
        if (typeof(sheetData["RepeatedElements"][0]["Time"]) != "undefined") {

            printContent += '<h2>Event Schedule</h2>' + 
                            '<ul style="margin: 0 0 20px;">';

            $.each(sheetData["RepeatedElements"], function(i, repeat) {
                var thisRepeatTime = "";
                var thisRepeatScheduleItem = "";
                $.each(repeat, function(repeatPropertyKey, repeatPropertyValue) {
                    if (StrInStr(repeatPropertyKey, "Time", 0) != false) {
                        thisRepeatTime = repeatPropertyValue;
                    } else if (StrInStr(repeatPropertyKey, "Schedule-Item", 0) != false) {
                        thisRepeatScheduleItem = repeatPropertyValue;
                    }
                });
                if (thisRepeatTime != "" && thisRepeatScheduleItem != "") {
                    printContent += '<li><b>' + thisRepeatTime + ':</b> ' + thisRepeatScheduleItem + '</li>';
                }
            });
            printContent += '</ul>';
        }
        ...
        if (typeof(sheetData["wolfgang-puck-catering_menu"]) != "undefined" ||
            typeof(sheetData["wolfgang-puck-catering_linens"]) != "undefined" ) {
            wpcHasContent = 1;
        }
        ...
        if (wpcHasContent == 1) {
            ...
            printContent += wpcOpeningTag + '<b>Menu and linens: </b>' + sheetData["Printer-WPC-Menu-Linens"] + wpcClosingTag;
        ...
        var iitHasContent = 0;
        if (typeof(sheetData["iit_infra"]) != "undefined" ||
            typeof(sheetData["iit_audiovisual"]) != "undefined" ) {
            iitHasContent = 1;
        }

        var iitUseList = 1;
        var iitOpeningTag = '<li>';
        var iitClosingTag = '</li>';
        ...
        if (iitHasContent == 1) {
            ...
            printContent += iitOpeningTag + '<b>Assistance: </b>' + sheetData["Printer-IIT-Assistance"] + iitClosingTag;

            printContent += iitOpeningTag + '<b>Account: </b>' + sheetData["IIT-Account-Number"] + iitClosingTag;
        ...
        if (typeof(sheetData["fire-detail_yes"]) != "undefined") { publicSafetyContentQuantity++; }
        ...
        if (publicSafetyHasContent == 1) {
            ...
            if (typeof(sheetData["fire-detail_yes"]) != "undefined") {
                printContent += publicSafetyOpeningTag + '<b>Fire Detail</b>' + publicSafetyClosingTag;
            }
        ...
        if (buyoutsHasContent == 1) {
            ...
            printContent += buyoutsOpeningTag + '<b>Venue(s): </b><ul style="margin: 0;">';
            if (typeof(sheetData["buyout-venues_omni"]) != "undefined") {
                printContent += buyoutsOpeningTag + 'Omni' + buyoutsClosingTag;
            }
            if (typeof(sheetData["buyout-venues_planetarium"]) != "undefined") {
                printContent += buyoutsOpeningTag + 'Planetarium' + buyoutsClosingTag;
            }
            if (typeof(sheetData["buyout-venues_4dtheater"]) != "undefined") {
                printContent += buyoutsOpeningTag + '4-D Theater' + buyoutsClosingTag;
            }
            if (typeof(sheetData["buyout-venues_nichols"]) != "undefined") {
                printContent += buyoutsOpeningTag + 'Nichols' + buyoutsClosingTag;
            }
            if (typeof(sheetData["buyout-venues_stearns"]) != "undefined") {
                printContent += buyoutsOpeningTag + 'Stearns' + buyoutsClosingTag;
            }
            if (typeof(sheetData["buyout-venues_other"]) != "undefined") {
                printContent += buyoutsOpeningTag + 'Other' + buyoutsClosingTag;
            }
            printContent += '</ul>' + buyoutsClosingTag;
        ...
        if (typeof(sheetData["Additional-Notes"]) != "undefined") {
            printContent += '       <tr>' + 
                            '           <td colspan="2" style="border: 2px solid black;padding: 1rem;">' + 
        ...
        printContent = ReturnPrintableContentWithStandardHeader (printContent);
        PrintToPrinter (printContent);
    }

    

    function ReturnPrintableContentWithStandardHeader (printContent) {
        return '<div id="print-header" ' + 
                'style="text-align: center; margin: 0 0 20px;' + 
                '"><img src="/sites/hubprod/Asset Library/header_print-view.png" style="margin: 0 auto;" /></div>'  + printContent;
    }



    function PrintToPrinter (printContent) {
        $("html").append('<div id="printer-content"></div>');
    ...
    function CallFunctionFromString (functionName, functionArgumentsArray) {
            ...
            if (StrInStr(id, 'approval-signature') == false && StrInStr(id, 'approval-date') == false && StrInStr(id, 'Approval-Notes') == false && StrInStr(id, 'approval-indicator') == false) {
                ...
                if (id.indexOf('TopSpan_HiddenInput') < 0) {
                    ...
                    if (type.toUpperCase() != "FILE") {
                        ...
                        // encode its value
                        var value = ReturnFileNameFromEndOfHtmlEncodedPath(HtmlEncode($("div#mos-form input#" + id).val()));
    ...
    $.fn.RenderListAsDatatable = function(options) {
        ...
        console.log('using list rendering 6');
        ...
        if (typeof(opt.listForDatatable[0]) == "undefined") {
            ...
            $("#table-container").append(tableMarkup);
        } else {
