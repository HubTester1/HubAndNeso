(function($) {
    ...
    $.fn.InitializeForm = function(mData, uniqueElements, customScriptFirst, customScriptLast) {
        ...
        if (typeof(mData.standardElementGroups.standardAdminAssignmentCompletionElements) != "undefined") {
            ...
            if (typeof(mData.standardElementGroups.standardAdminAssignmentCompletionElements.additionalAdminFields) == "undefined") {
                mData.standardElementGroups.standardAdminAssignmentCompletionElements.additionalAdminFields = [];
            }
            ...
            var standardAdminAssignmentCompletionElements1 = [{
                ...
                'onChange': [{
                    ...
                    }, // "show": [{ "fieldName": "Requested For" }],
                    {
                        "thisFieldEquals": ["", "Cancel"],
                        "optional": [{
                            "fieldName": "Completed By",
                            "type": "peoplepicker"
                        }]
        ...
        if (mData.standardElementGroups.standardAdminElements != undefined) {
            ...
            if (typeof(mData.standardElementGroups.standardAdminElements.additionalAdminFields) == "undefined") {
                mData.standardElementGroups.standardAdminElements.additionalAdminFields = [];
            }
        ...
        $.each(mData.elements, function(i, elem) {
            if (elem.controlType == "select") {
                if (typeof(elem.loadOptions) != "undefined") {
                    $("#" + ReplaceAll(" ", "-", elem.fieldName)).LoadSelectOptions(elem.loadOptions);
                }
            }
        ...
        $('div#all-content-container').on('click', 'span.ms-entity-resolved', function() {
            ...
            if (typeof(userProfileValues["SPS-PersonalSiteCapabilities"]) != 'undefined' && userProfileValues["SPS-PersonalSiteCapabilities"] != '') {
                dialogBody += '   <li id="profile"><a href="' + StrInStr(location.pathname, 'SitePages', 1) + '_layouts/15/userdisp.aspx?ID=' + userProfileValues["SPS-PersonalSiteCapabilities"] + '" target="_blank">Profile</a></li> \n';
            }
            ...
            if (rData.lastModMismatch == 0) {
                ...
                $.each(mData.elements, function(i, elem) {
                    ...
                    if (typeof(elem.isoFormatOnSubmit) != "undefined") {
                        ...
                        // determine the date field selector from the element's other properties
                        var fieldsSelector = "[id^='" + ReplaceAll(" ", "-", elem.fieldName) + "']";
            ...
            $().SPServices({
                ...
                completefunc: function(xData, Status) {
                    ...
                    $(xData.responseXML).SPFilterNode("z:row").each(function() {
                        ...
                        // replace single quotes / apostrophes so that value renders correctly in browser
    ...
    $.fn.BuildMultifield = function(e, isAdmin, rStatus) {
        ...
        e.hypehnatedName = ReplaceAll(" ", "-", e.multifieldName);
        e.hypehnatedNameLower = ReplaceAll(" ", "-", e.multifieldName).toLowerCase();
        ...
        $.each(e.subfields, function(i, subfield) {
            ...
            subfield.hypehnatedName = ReplaceAll(" ", "-", subfield.subfieldName);
            subfield.hypehnatedNameLower = ReplaceAll(" ", "-", subfield.subfieldName).toLowerCase();
    ...
    $.fn.BuildListItemChooserField = function(e, isAdmin, rStatus) {
        ...
        field += '        <input type="text" id="text_' + e.hypehnatedName + '"';
        ...
        field += 'class="text_list-item-chooser ' +
            $().AddMarkupClass(e, isAdmin, rStatus, "disabledForAdmin", "disabledForNonAdmin") +
            $().AddMarkupClass(e, isAdmin, rStatus, "requiredForAdmin", "requiredForNonAdmin") +
            '" ';
        ...
        field += '        <a id="anchor_' + e.hypehnatedName + '"';

        field += 'class="anchor_list-item-chooser ' +
    ...
    $.fn.BuildScript = function(e, uData, mData) {
        ...
        if (typeof(e.onChange) != "undefined") {
            ...
            if (e.controlType == "radio" || e.controlType == "check") {
                ...
                stmtsToAdd += '$("#text_' + e.hypehnatedName + '").on("change", function () { \n';
            ...
            $.each(e.onChange, function(i, chg) {
                ...
                if (typeof(chg.show) != "undefined") {
                    ...
                    $.each(chg.show, function(i, sh) {
                        if (typeof(sh.fieldName) != "undefined") {
                            var shID = '#label-and-control_' + ReplaceAll(" ", "-", sh.fieldName);
                        }
                        if (typeof(sh.noteID) != "undefined") {
                            var shID = '#' + ReplaceAll(" ", "-", sh.noteID);
                        }
                        if (typeof(sh.divID) != "undefined") {
                            var shID = '#' + ReplaceAll(" ", "-", sh.divID);
                        }
                        if (typeof(sh.divClass) != "undefined") {
                            var shID = '.' + ReplaceAll(" ", "-", sh.divClass);
                        }
                ...
                if (typeof(chg.hide) != "undefined") {
                    ...
                    $.each(chg.hide, function(i, hd) {
                        if (typeof(hd.fieldName) != "undefined") {
                            var hdID = '#label-and-control_' + ReplaceAll(" ", "-", hd.fieldName);
                        }
                        if (typeof(hd.noteID) != "undefined") {
                            var hdID = '#' + ReplaceAll(" ", "-", hd.noteID);
                        }
                        if (typeof(hd.divID) != "undefined") {
                            var hdID = '#' + ReplaceAll(" ", "-", hd.divID);
                        }
                        if (typeof(hd.divClass) != "undefined") {
                            var hdID = '.' + ReplaceAll(" ", "-", hd.divClass);
                        }
                ...
                if (typeof(chg.disable) != "undefined") {
                    ...
                    $.each(chg.disable, function(i, dis) {
                        // if not visible, show
                        stmtsToAdd += '      if (!$("#label-and-control_' + ReplaceAll(" ", "-", dis.fieldName) + ' div.field-type-indication span.field-type-indicator").hasClass("field-disabled")) { \n';
                        ...
                        if (typeof(dis.inputIDs) == 'undefined' && typeof(dis.selectIDs) == 'undefined') {
                            stmtsToAdd += '         $().SetFieldToDisabled("#' + ReplaceAll(" ", "-", dis.fieldName) + '"); \n';
                        }
                ...
                if (typeof(chg.enable) != "undefined") {
                    ...
                    $.each(chg.enable, function(i, en) {
                        // if not visible, show
                        stmtsToAdd += '      if ($("#label-and-control_' + ReplaceAll(" ", "-", en.fieldName) + ' div.field-type-indication span.field-type-indicator").hasClass("field-disabled")) { \n';
                        ...
                        if (typeof(en.inputIDs) == 'undefined' && typeof(en.selectIDs) == 'undefined') {
                            stmtsToAdd += '         $().SetFieldToEnabled("#' + ReplaceAll(" ", "-", en.fieldName) + '"); \n';
                            stmtsToAdd += '         if ($("#' + ReplaceAll(" ", "-", en.fieldName) + '").attr("data-is-date") == "true") { \n';
                            stmtsToAdd += '             $("#' + ReplaceAll(" ", "-", en.fieldName) + '").datepicker({ \n';
                            stmtsToAdd += '                changeMonth: "true", \n';
                            stmtsToAdd += '                 changeYear: "true", \n';
                            stmtsToAdd += '                 dateFormat: "MM d, yy" \n';
                            stmtsToAdd += '             }); \n';
                ...
                if (typeof(chg.set) != "undefined") {
                    ...
                    $.each(chg.set, function(i, set) {
                        if (set.type == "text" || set.type == "textarea") {
                            ...
                            stmtsToAdd += '     $("#' + ReplaceAll(" ", "-", set.fieldName) + '").prop("selectedIndex", ' + set.optionIndex + '); \n';
        ...
        if (e.controlType == "time") {

            stmtsToAdd += '\n$("#hours-input_' + e.hypehnatedName + ', #minutes-input_' + e.hypehnatedName + '").on("change", function () { \n' +
                '   if ($("#hours-input_' + e.hypehnatedName + '").val().length > 0 && $("#minutes-input_' + e.hypehnatedName + '").val().length > 0) { \n' +
                '       $("#time-storage_' + e.hypehnatedName + '").val($().ReturnISODateTimeFromParts({ "date": "January 01, 2000", "hour": $("#hours-input_' + e.hypehnatedName + '").val(), "minute": $("#minutes-input_' + e.hypehnatedName + '").val() })); \n' +
                '   } else { \n' +
                '       $("#time-storage_' + e.hypehnatedName + '").val(""); \n' +
                '   } \n' +
                '}); \n';
        ...
        if (e.controlType == "listItemChooser") {
            ...
            stmtsToAdd += '\n$("#all-content-container").append("\\x3cdiv id=\\x22list-item-dialog\\x22\\x3e\\x3c/div\\x3e"); \n' +
                ...
                '   $("input#text_' + e.hypehnatedName + '").val($(this).text()); \n' +
                '   $("input#text_' + e.hypehnatedName + '").trigger("change"); \n' +
    ...
    $.fn.ImportEventRequestDataToEventAVRequest = function(requestID) {

        var eventRData = $().GetFieldsFromOneRow({
            "listName": "swfList",
            "webURL": "https://bmos.sharepoint.com/sites/vxo-function",
            "select": [{
                "nameHere": "formData",
                "nameInList": "AllRequestData"
            }],
    ...
    $.fn.ImportEventSpaceRequestDataToEventEventRequest = function(requestID) {

        var eventRData = $().GetFieldsFromOneRow({
            "listName": "swfList",
            "webURL": "https://bmos.sharepoint.com/sites/vxo-function-space",
            "select": [{
                "nameHere": "formData",
                "nameInList": "AllRequestData"
            }],
