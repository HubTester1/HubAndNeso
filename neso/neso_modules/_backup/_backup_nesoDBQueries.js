...
var nesoDatabaseQueries = function() {

	var ReturnAllDocsFromCollection = function(collection) {
		// return a new promise
		return new Promise(function(resolve, reject) {
			// using the nesoDBConnection object, get the specified collection from the db; that is, use the db connection 
			...
			nesoDBConnection.get(collection).find({},{},function(error, docs) {
	...
	var InsertDocIntoCollection = function(doc, collection) {
		...
		return new Promise(function(resolve, reject) {
			...
			//      to fill the docs var with db documents; use find method with empty query and options 
			//      objects to select all docs and invoke callback
			nesoDBConnection.get(collection).insert(doc, function(error, result) {
				// if there was an error
				if (error) {
					// construct a custom error
					var errorToReport = {
	...
	var OverwriteDocInCollection = function(docID, doc, collection) {
		...
		return new Promise(function(resolve, reject) {
			...
			//      to fill the docs var with db documents; use find method with empty query and options 
			//      objects to select all docs and invoke callback
			nesoDBConnection.get(collection).update({ '_id' : docID }, doc, function(error, countsFromMonk) {
				// if there was an error
				if (error) {
					// construct a custom error
					var errorToReport = {
	...
	var DeleteDocFromCollection = function(docID, collection) {
		...
		return new Promise(function(resolve, reject) {
			...
			//      to fill the docs var with db documents; use find method with empty query and options 
			//      objects to select all docs and invoke callback
			nesoDBConnection.get(collection).remove({ '_id' : docID }, function(error, resultFromMonk) {
				// if there was an error
				if (error) {
					// construct a custom error
					var errorToReport = {
	...
	var DeleteAllDocsFromCollection = function(collection) {
		...
		return new Promise(function(resolve, reject) {
			...
			//      to fill the docs var with db documents; use find method with empty query and options 
			//      objects to select all docs and invoke callback
			nesoDBConnection.get(collection).remove({}, function(error, resultFromMonk) {
				// if there was an error
				if (error) {
					// construct a custom error
					var errorToReport = {
...
module.exports = nesoDatabaseQueries;