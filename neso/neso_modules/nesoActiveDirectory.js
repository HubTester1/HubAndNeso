					...
					const hardCodedManagers = [
						{
							...
							firstInitial: 'K', 
							lastInitial: 'S', 
							displayName: 'Karen Sveda', 
							title: 'AVP, Leadership & Planned Giving', 
							email: 'ksveda@mos.org', 
							officePhone: '617-589-0468', 
							mobilePhone: '', 
							manager: 'elliestarr', 
							department: 'Leadership/Planned Giving', 
							division: 'Advancement', 
							securityGroups: ['Budget_Advancement', 'mos.org', 'AdvancementData', 'Tessitura Advancement', 'Development', 'OS X Users', 'Web VPN Access', 'Leadership and Planned Giving', 'WiFi Access', 'PGP_BASIC', 'Budget_RestrictedAccess', 'AnyConnect VPN Access'],
						}, {
