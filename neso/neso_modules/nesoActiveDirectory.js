					...
					const hardCodedManagers = [
						{
							...
							firstInitial: 'C',
							lastInitial: 'C',
							displayName: 'Colleen Casey',
							title: 'Manager, Advancement Marketing & Communications',
							email: 'ccasey@mos.org',
							officePhone: '617-589-0242',
							mobilePhone: '',
							manager: 'abuzay',
							department: 'Advancement Communications',
							division: 'Advancement',
							securityGroups: ['Budget_Advancement', 'mos.org', 'AdvancementData', 'Tessitura Advancement', 'Development', 'SP_Staff', 'OS X Users', 'Web VPN Access', 'Advancement Communications', 'WiFi Access', 'Budget_RestrictedAccess', 'AnyConnect VPN Access'],
						}, {
							...
							firstInitial: 'K',
							lastInitial: 'T',
							displayName: 'Karen Turpin',
							title: 'Director, Planned Giving',
							email: 'kturpin@mos.org',
							officePhone: '',
							mobilePhone: '',
							manager: 'aberkeley',
							department: 'Leadership & Planned Giving',
							division: 'Advancement',
							securityGroups: ['Exhibits_Projects_What_Is_Technology', 'Resources', 'ENews Editors', 'mos.org', 'TrackIT Users', 'AdvancementData', 'Tessitura Advancement', 'Development', 'GPC', 'SP_Staff', 'Web VPN Access', 'Leadership and Planned Giving', 'Showcase', 'WiFi Access', 'Advancement Administration', 'PGP_BASIC', 'Crystal Enterprise', 'Tech Showcase', 'AnyConnect VPN Access'],
						}, {
